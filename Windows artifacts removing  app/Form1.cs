...
namespace Windows_artifacts_removing__app
{
...

    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Файл не найден,ошибка", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MessageBox.Show("Ошибка при открытии файла: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            textBox1.Text = "Your image location";
